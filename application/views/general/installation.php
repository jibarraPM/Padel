...
<head>
    ...
    <title>Installation | Proyecto Mapache</title>
...
<header>
    <div class="container">
        <h1 class="page-title">Proyecto Mapache Installation</h1>
    </div>
</header>

<div class="content container">
    <div class="welcome">
        <h3>Welcome to the Proyecto Mapache installation page.</h3>
        <p>
            This page will help you set the main settings of your Proyecto Mapache installation.
            ...
            url to connect to the backend section of Proyecto Mapache.

            If you face any problems during the usage of Proyecto Mapache you can always check the
    ...
    <p>
    <h3>License</h3>
    Proyecto Mapache is licensed under the <span class="badge badge-default">GPL-3.0 license</span>.
    By using the code of Proyecto Mapache in any way <br> you agree with the terms described in the
    following url:
