...
/**
 * Check if Proyecto Mapache is installed.
 *
 * This function will check some factors to determine if Proyecto Mapache is installed or not. It is possible that the
