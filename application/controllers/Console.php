 ...
 * Class Console
 *
 * CLI commands of Proyecto Mapache, can only be executed from a terminal and not with a direct request.
 */
class Console extends EA_Controller {
     ...
     *
     * Use this method to install Proyecto Mapache directly from the terminal.
     *
     * Usage:
     *
     ...
     *
     * Use this method to backup your Proyecto Mapache data.
     *
     * Usage:
     *
     ...
     *
     * Use this method in a cronjob to automatically sync events between Proyecto Mapache and Google Calendar.
     *
     * Notice:
     *
    ...
    public function help()
    {
        $help = [
            '',
            'Proyecto Mapache ' . config('version'),
            '',
            'Usage:',
            '',
