 ...
 * Class Google_sync
 *
 * This class implements all the core synchronization between the Google Calendar and the Proyecto Mapache system.
 *
...
class Google_sync {
     ...
     * where the user grants access to his data for the Proyecto Mapache app.
     */
     ...
     * when the provider granted consent to Proyecto Mapache for use his
     ...
     *
     * This method checks whether the appointment's provider has enabled the Google Sync utility of Proyecto Mapache
     ...
     * provided appointment record of Proyecto Mapache.
     *
     * @param array $appointment Contains the appointment record data.
     * @param array $provider Contains the provider record data.
     * @param array $service Contains the service record data.
