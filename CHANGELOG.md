...
- #664: Proyecto Mapache v1.3.2 allows sensitive information disclosure (username and password hash).
...
- #176: Add Docker container for Proyecto Mapache development.
...
- #21: Fix Proyecto Mapache installation problems with AJAX requests.
- #66: Trouble with breaks for providers.

## [1.0.0] - 2014-01-19 

First Proyecto Mapache release ever! ☺
