...
**Proyecto Mapache** is a highly customizable web application that allows customers to book appointments with you 
...
Proyecto Mapache will run smoothly with your existing website as it can be installed in a single folder of the 
...
* Open the browser on the Proyecto Mapache URL and follow the installation guide.
